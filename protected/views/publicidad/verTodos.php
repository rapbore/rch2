...
<?php $this->widget('bootstrap.widgets.TbGridView', array(
	...
	'columns' => array(
		...
		'estado',
			...
			'buttons'=>array(
				'view' => array(
					'label'=>'Ver Publicidad',
					'url'=>'Yii::app()->createUrl("publicidad/ver", array("id"=>$data->id))',
				),
                            
                                'update' => array(
					'label'=>'Actualizar Publicidad',
					'url'=>'Yii::app()->createUrl("publicidad/actualizar", array("id"=>$data->id))',
				),
                            
                                'delete' => array(
					'label'=>'Eliminar Publicidad',
					'url'=>'Yii::app()->createUrl("publicidad/eliminar", array("id"=>$data->id))',
				),
